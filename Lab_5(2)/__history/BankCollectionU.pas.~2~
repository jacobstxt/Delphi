...
type
  ...
  private
    FName: string;
    FAccounts: array[0..MaxAccounts - 1] of BankAccount; // масив посилань
    FCount: Integer;
  public
    constructor Create(AName: string);
    procedure AddAccount(Account: BankAccount);   // приймає вже створений об'єкт
...
// Агрегування: Bank НЕ створює рахунок, а лише ПРИЙМАЄ вже існуючий
...
begin
  ...
  begin
    ...
    begin
      // Зсуваємо масив, але НЕ знищуємо об'єкт — він існує далі!
