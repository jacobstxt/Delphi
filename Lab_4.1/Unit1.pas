...
Pen.Width := 3;
Pen.Color := clRed;
Rectangle(rect1.coord[0], rect1.coord[1],rect1.coord[2], rect1.coord[3]); // червоний прямокутник
Pen.Width := 4;
Pen.Color:=clGreen;
Rectangle(rect2.coord[0], rect2.coord[1],rect2.coord[2], rect2.coord[3]); // зелений прямокутник
End;
